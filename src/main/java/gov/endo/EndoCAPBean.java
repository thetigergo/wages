 ...
 * @author felix
 */
public class EndoCAPBean implements java.io.Serializable {
...
//        private final String MyIDs, Names;
//        private final Float Rates;
//
//        public WorkerAttrib(String id, String name, Float rate) {
//            MyIDs = id; Names = name; Rates = rate;
//        }
//
//        public String getMyIDs() {return MyIDs;}
//
