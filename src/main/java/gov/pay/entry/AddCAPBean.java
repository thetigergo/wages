 ...
 * @author felix
 */
public class AddCAPBean implements java.io.Serializable {

    private static final long serialVersionUID = 6807259496687949380L;
    ...
    private Short Minutes = 0;//, Napili = -1;
...
//    public Short getNapili() {return Napili;}
//    public void setNapili(Short value) {Napili = value;}
        ...
        try (org.postgresql.core.BaseConnection jdbc = new gov.dbase.PgSQLConn();
            ...
            try (java.sql.ResultSet rst = _smt.executeQuery(
                    ...
                    "WHERE " +
                        ...
                        //"('" + dateTo + "' BETWEEN frdate AND todate) " + 
...
//    public void onBulana() {
//        int year; 
//        java.util.Calendar cal = java.util.Calendar.getInstance();
//        cal.setTime(onlineUser.getMgaPetsa());
//        year = cal.get(java.util.Calendar.YEAR);
//        cal.set(year, Napili, 1);
//        //PayFr.setTime(cal.getTimeInMillis());
//        PayFr = cal.getTime();
//    }
    
//    public void onNapilian() {
//        int year, buan;
//        java.util.Calendar cal = java.util.Calendar.getInstance();
//        cal.setTime(PayFr);
//        switch (Napili) {
//            case 0: //Whole Month
//                year = cal.get(java.util.Calendar.YEAR);
//                buan = cal.get(java.util.Calendar.MONTH);
//                cal.set(year, buan + 1, 0);
//                PayTo = cal.getTime();
//                break;
//            case 1: //1st Quincena
//                year = cal.get(java.util.Calendar.YEAR);
//                buan = cal.get(java.util.Calendar.MONTH);
//                cal.set(year, buan, 15);
//                PayTo = cal.getTime();
//                break;
//            default: //2nd Quincena
//                year = cal.get(java.util.Calendar.YEAR);
//                buan = cal.get(java.util.Calendar.MONTH);
//                cal.set(year, buan, 16);
//                PayFr.setTime(cal.getTimeInMillis());
//                cal.set(year, buan + 1, 0);
//                PayTo = cal.getTime();
//        }
