 ...
 * @author felix
 */
public class WageATMBean implements java.io.Serializable {

    private static final long serialVersionUID = -6425287318721996883L;
...
//    }
    ...
    public void saveEntry(javax.faces.event.ActionEvent event) {
        /** Example kung naay plano gamiton **/
