 ...
 * @author USER
 */
public class PgSQLbind /*implements org.postgresql.core.BaseConnection*/ {

//    private static final String[] SERVER = {"172.16.0.14"};
//    private final  org.postgresql.core.BaseConnection mJDBC;
//
//    public PgSQLbind() throws java.sql.SQLException {
...
//    }
//    
//    public PgSQLbind(String database) throws java.sql.SQLException {
//        org.postgresql.ds.PGSimpleDataSource pg = new org.postgresql.ds.PGSimpleDataSource();
//        pg.setServerNames(SERVER);
//        //pg.setPortNumber(port != 0 ? port : 5432);
